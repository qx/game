...
public class Start_page_career extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		extras2=this.getIntent().getExtras();
        ...
        .setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == m_Radio1.getId()) {
                    extras2.putString("职业", "智力");
                } else if (checkedId == m_Radio2.getId()) {
                    extras2.putString("职业", "敏捷");
                } else if (checkedId == m_Radio3.getId()) {
                    extras2.putString("职业", "力量");
                } 
            }
        });
		Toast.makeText(this, extras2.getString("国家"),
                Toast.LENGTH_SHORT).show();//test
		career_next.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent nickname = new Intent(Start_page_career.this,
						Start_page_nickname.class);
				nickname.putExtras(extras2);
